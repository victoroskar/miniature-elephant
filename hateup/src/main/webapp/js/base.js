...
google.devrel.samples.hello.CLIENT_ID =
    '185551852516-k2544i1cuv8ph7u1i2k0fu625jqs5seu.apps.googleusercontent.com';
...
google.devrel.samples.hello.init = function(apiRoot) {
  // Loads the OAuth and hateup APIs asynchronously, and triggers login
  ...
  gapi.client.load('hateup', 'v1', callback, apiRoot);
